...
function ButtonStyle({
  ...
  const styles = {
    primary: baseStyle + "px-2 py-3 sm:px-6 sm:py-4",
    small: baseStyle + "px-2 py-2 sm:px-5 sm:py-2.5 text-xs",
    secondary: secondaryBaseStyle + "px-2 py-2.5 sm:px-6 sm:py-3.5",
    notActive: secondaryBaseStyle + "py-2 px-2 sm:px-5 sm:py-2.5 text-xs",
